...
public class ReverseAidenBarriosMechanismCommand extends SequentialCommandGroup {

    public ReverseAidenBarriosMechanismCommand(AidenBarriosMechanismSubsystem subsystem) {
        addCommands(
        // Step 1: Command the elevator to move to L1
        new InstantCommand(() -> subsystem.goUp()),
